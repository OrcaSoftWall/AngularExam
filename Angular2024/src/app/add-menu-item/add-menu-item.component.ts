...
//   //     this.menuService.addMenuItem(this.menuItemForm.value).then(() => {
...
//           formValue.photoURL = downloadURL; // Use the file's download URL as the photoURL
...
//     const filePath = `menu_photos/${Date.now()}_${file.name}`; // Create a unique path for the file
//     const fileRef = this.storage.ref(filePath);
//     return this.storage.upload(filePath, file).then(() => {
//       return fileRef.getDownloadURL().toPromise(); // Return the download URL for the uploaded file
//     });
//   }
